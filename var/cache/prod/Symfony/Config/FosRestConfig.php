...
class FosRestConfig implements \Symfony\Component\Config\Builder\ConfigBuilderInterface
{
    ...
    */
     ...
     * @template TValue
     * @param TValue $value
     * @default {"enabled":false,"map_exception_codes":false,"exception_listener":false,"serialize_exceptions":false,"flatten_exception_format":"legacy","serializer_error_renderer":false,"codes":[],"messages":[],"debug":false}
